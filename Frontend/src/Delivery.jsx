...
<div className=' conatiner  m-4 d-flex gap-3   col-md-8 mx-auto '>
 ...
 {tokens ? <h3 className='   fw-dark'> Review</h3>:
...
<div className='container d-flex justify-content-between'>
  ...
  <button className='btn btn-primary rounded-pill text-dark ' style={{width:"400px",backgroundColor:"#e9e951"}}><i class="bi bi-geo-alt"></i> Delivery at {current_add} </button> }
    {saved_add && saved_add!="undefined-undefined" && 
  <button className='btn btn-primary rounded  rounded-pill text-dark ' style={{width:"400px",backgroundColor:"#e9e951"}}><i class="bi bi-geo-alt"></i> Delivery at {saved_add} </button> }
  <buttton className="btn btn-primary rounded-pill text-dark but" style={{width:"100px",backgroundColor:"#e9e951"}} onClick={()=>navigat('/address_details')}>Change</buttton>
</div>
</div>
<hr></hr>
...
<div className='container d-flex justify-content-center mt-4'>
  <button className='btn  fw-bold rounded-pill but ' style={{width:"400px",backgroundColor:"#e9e951"}} >Continue</button>
</div>
