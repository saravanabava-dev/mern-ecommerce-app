...
<div className='fw-semibold d-flex flex-column gap-4 mt-5 cc ms-1 ps-5 p-4' style={{marginLeft:"150px"}}>
...
<div className="d-flex   px-3 py-1 rounded-pill quantity "   style={{backgroundColor:"#FFFF8A"}}>
  ...
  <button className="btn btn-light btn-sm rounded-circle"  onClick={update6}>+</button>
    ...
    <button className='btn btn-danger but' onClick={()=>{reseting();navigate('/price4',{state:{
men:men,
women:women,
kids:[0,0,0,0,0,0]
    }})}}>Reset</button>
